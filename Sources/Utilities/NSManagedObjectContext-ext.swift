...
extension NSManagedObjectContext
  {
    ...
    @discardableResult
    public func create<T: Entity>(_ type: T.Type = T.self, initialize: (T) throws -> Void = {_ in }) throws -> T
      {
    ...
    public func fetchObjects<T: Entity>(_ request: NSFetchRequest<T>) throws -> [T]
      {
    ...
    public func tryFetchObject<T: Entity>(_ request: NSFetchRequest<T>) throws -> T?
      {
    ...
    public func fetchObject<T: Entity>(_ request: NSFetchRequest<T>) throws -> T
      {
