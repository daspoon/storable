    ...
    func testAttributeStorageType() throws
      {
        ...
        @objc class Attributed_v1 : Entity {
          @Attribute("a")
          var a : Int
        }
        @objc class Attributed_v2 : Entity {
          @Attribute("a")
          var a : String
        }
